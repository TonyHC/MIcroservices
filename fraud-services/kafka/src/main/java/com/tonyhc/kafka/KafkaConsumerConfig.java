...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, NotificationRequest> consumerFactory() {
        ...
        jsonDeserializer.addTrustedPackages("com.tonyhc.clients.notification");
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, NotificationRequest>> notificationFactory() {
